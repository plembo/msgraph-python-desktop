...
"""
# For simplicity, we'll read config file from 1st CLI param
# sys.argv[1]#
import sys
import json
import logging
...
if "access_token" in result:
    ...
    print(result.get("correlation_id"))  # You may need this to report a bug
    if 65001 in result.get("error_codes", []):
        # Not meant to be coded programatically, but...
